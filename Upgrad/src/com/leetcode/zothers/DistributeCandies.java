...
public class DistributeCandies {
    ...
    static int getDistributeCandies(int[] candyType){
        Set<Integer> hset = new HashSet<>();
        int n = candyType.length;
        for(int i=0; i<n ;i++){
            hset.add(candyType[i]);
        }
        System.out.println("getDistributeCandies hset " + hset);
        int uniqueType = hset.size();
        System.out.println("getDistributeCandies uniqueType " + uniqueType);
    ...
    static int getDistributeCandies1(int[] candyType){
