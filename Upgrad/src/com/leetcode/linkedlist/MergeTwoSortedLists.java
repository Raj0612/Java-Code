...
public class MergeTwoSortedLists {
    ...
    public static ListNode mergeTwoListsByRecursion1(ListNode list1, ListNode list2) {
        ...
        ListNode.printList("mergeTwoListsByRecursion1 after if list1",list1);
    ...
    public static ListNode mergeTwoListsByReverse(ListNode list1, ListNode list2) {
       ...
       // list2 = reverseList(list2);
        ...
        ListNode.printList("mergeTwoListsByReverse", head);
        ListNode result = reverseListByRecursion(head);
        return result;
    }
