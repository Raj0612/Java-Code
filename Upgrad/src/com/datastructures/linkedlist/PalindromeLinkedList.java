...
public class PalindromeLinkedList {
    ...
    public static boolean isPalindrome(ListNode head) {
        ...
        ListNode.printList("isPalindrome mid: ", mid);
    ...
    public static ListNode reverseList(ListNode head){
        ...
        ListNode.printList("reverseList next", next);
    ...
    static void input3(){
        ...
        System.out.println("input3 middleNode " + middleNode(node));


        ListNode.printList("reverseList",  reverseList(node));
    }
}
