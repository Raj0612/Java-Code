...
public class BuyStockCommand implements TradeCommand {
    ...
    public BuyStockCommand(Member member, Stock stock, double quantity, double price, TimeEnforcementType enforcementType) {
        this.member = member;
        this.stock = stock;
    ...
    @Override
    public void execute() {
        StockExchange.getInstance().buyStock(member, stock, quantity, price, enforcementType);
    }
}