...
public abstract class Match {
    ...
    public List<Playing11> getTeams() {
    ...
    public Playing11 getTossWin() {
        return tossWin;
    }

    public Map<Umpire, UmpireType> getUmpires() {
        return Collections.unmodifiableMap(umpires);
    }
    ...
    public List<MatchStat> getStats() {
    ...
    public void setTossWin(Playing11 tossWin) {
    ...
    public void addTeam(Playing11 team) {
        teams.add(team);
    }
    ...
    public void addUmpire(Umpire umpire, UmpireType type) {
        umpires.put(umpire, type);
    }
    ...
    public void addStat(MatchStat stat) {
        stats.add(stat);
    }
}
