package ashishps1.parkinglot;

import ashishps1.parkinglot.fee.VehicleBasedFeeStrategy;
import ashishps1.parkinglot.vehicletype.*;
...
public class ParkingLotDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            double fee = parkingLot.unparkVehicle(ticketID); // valid ticket ID
