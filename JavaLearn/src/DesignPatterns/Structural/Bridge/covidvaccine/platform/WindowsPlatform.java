...
public class WindowsPlatform implements MultiPlatformFramework {
    ...
    public void registerUser(User user) {
        ...
        System.out.println("User registered successfully by Windows application at " + LocalDateTime.now());
    }
    ...
    public void uploadVaccineCount(String userId, String date, int noOfVaccines) {
        ...
        System.out.println("Vaccine count is updated by " + user.getUserName() + " of center = " + center + " by windows platform");
    }
}
