...
public class AndroidPlatform implements MultiPlatformFramework{
    @Override
    ...
    public void registerUser(User user) {
        ...
        System.out.println("User registered successfully by Android application at "+ LocalDateTime.now());
    }
    ...
    public void uploadVaccineCount(String userId, String date, int noOfVaccines) {
        ...
        System.out.println("Vaccine count is updated by "+user.getUserName()+" of center = "+center+" by android platform");
    }
