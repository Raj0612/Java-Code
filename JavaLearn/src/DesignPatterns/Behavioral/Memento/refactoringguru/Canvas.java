...
import DesignPatterns.Behavioral.Memento.refactoringguru.shape.Shape;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                DesignPatterns.Behavioral.Memento.refactoringguru.shape.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
