...
public class EMethodReferenceTypes {
    ...
    public static void boundMethodReferences(){
        ...
        System.out.println("boundMethodReferences:" + lowerL.get());
        System.out.println("boundMethodReferences: " + lowerMR.get());
        ...
        System.out.println("boundMethodReferences:" + titleL.test("Mr.")); // true
        System.out.println("boundMethodReferences:" + titleMR.test("Ms."));// false
        System.out.println();
    }
    ...
    public static void unboundMethodReferences(){
        ...
        System.out.println("unboundMethodReferences: " +upperL.apply("sean"));   // SEAN
        System.out.println("unboundMethodReferences: " + upperMR.apply("sean"));  // SEAN
        ...
        System.out.println("unboundMethodReferences: " + concatL.apply("Sean ", "Kennedy"));// Sean Kennedy

        // 1st parameter is used for executing the instance method
        // "Sean ".concat("Kennedy")
        System.out.println("unboundMethodReferences: " + concatMR.apply("Sean ", "Kennedy"));// Sean Kennedy
    ...
    public static void constructorMethodReferences(){
        ...
        System.out.println("constructorMethodReferences: " + sb1);
        StringBuilder sb2 = sbMR.get();
        sb2.append("method reference version");
        System.out.println("constructorMethodReferences: " + sb2);
        ...
        ls1.add("21"); 
        System.out.println("constructorMethodReferences: " + ls1);//[21]
        List<String> ls2 = alMR.apply(5);  // size 5
        ls2.add("88"); 
        System.out.println("constructorMethodReferences: " + ls2);//[88]
    ...
    public static void staticMethodReferences(){
        ...
        System.out.println("staticMethodReferences: " + listOfNumbers);  // [1, 2, 4, 5, 9]

        listOfNumbers = Arrays.asList(8,12,4,3,7);
        sortMR.accept(listOfNumbers);// execution
        System.out.println("staticMethodReferences: " + listOfNumbers);  // [3, 4, 7, 8, 12]
    }    
}
