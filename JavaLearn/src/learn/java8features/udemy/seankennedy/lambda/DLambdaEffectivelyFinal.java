...
public class DLambdaEffectivelyFinal {
    String name="";
    ...
    public static void main(String[] args) {
        ...
        Predicate<String> lambda = s -> {
            //x++;
            new DLambdaEffectivelyFinal().name = "Kennedy";  // instance/class vars are ok
        ...
        new DLambdaEffectivelyFinal().name = "Sean"; // instance/class vars are ok
