package learn.java8features.udemy.seankennedy.stream.primitivestreams;
...
public class PrimitiveStreams {
    ...
    public static void stats(IntStream numbers){
        ...
        System.out.println("min: " + min);// 5 (2147483647 if nothing in stream)
        int max = intStats.getMax();
        System.out.println("max: " +max);// 20 (-2147483648 if nothing in stream)
        double avg = intStats.getAverage();
        System.out.println("avg: " + avg);// 12.5 (0.0 if nothing in stream)
        long count = intStats.getCount();
        System.out.println("count: " +count);// 4 (0 if nothing in stream)
        long sum = intStats.getSum();
        System.out.println("sum: " + sum);// 50 (0 if nothing in stream)
        System.out.println();
    ...
    public static void maxMinAverage(){
        ...
        System.out.println(min.orElseThrow(() -> new NoSuchElementException("No value present")));// 10.0

        OptionalDouble average = LongStream.of(10L, 20L, 30L)
                .average(); // terminal operation
        System.out.println("average:" + average.orElseGet(() -> Math.random()));// 20.0
        System.out.println();
    }
