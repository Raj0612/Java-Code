package learn.java8features.udemy.seankennedy.stream.terminaloperations;
...
public class TerminalOperations {
    ...
    public static void doReduce2(){
        ...
        Integer val = Stream.of(1,1,5)
                //     .filter(n -> n > 5)      // val is 1 this way
                       .reduce(1, (a, b) -> b );// val is 1 this way too
        System.out.println("doReduce2: " + val);// 1
    }
    public static void doReduce1(){
        System.out.println("doReduce1");
...
//                       .reduce("nothing", (s, c) -> s + c);
        ...
        Integer product = Stream.of(2,3,4)
                       .reduce(1, (a, b) -> a * b);
        System.out.println("doReduce1: " +product);// 24
 ...
 //       for(Integer i : s){}// error: required array or Iterable
    ...
    public static void doFindAnyFindFirst(){
        System.out.println("doFindAnyFindFirst");
        // Optional<T> findAny()
        ...
        any.ifPresent(x -> System.out.println(any));
        if(any.isPresent()){
