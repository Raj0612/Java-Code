...
public class CollectorsExamples {
    ...
    public static void doPartitioning3(){
        System.out.println("doPartitioning3");
    ...
    public static void doPartitioning2(){
        System.out.println("doPartitioning2");
        Stream<String> names = Stream.of("Thomas", "Teresa", "Mike", "Alan", "Peter");
        Map<Boolean, List<String>> map =
                names.collect(
                    // pass in a Predicate
    ...
    public static void doPartitioning1(){
        System.out.println("doPartitioning1");
        Stream<String> names = Stream.of("Thomas", "Teresa", "Mike", "Alan", "Peter");
        Map<Boolean, List<String>> map =
                names.collect(
                    // pass in a Predicate
    ...
    public static void doGroupingBy3(){
        System.out.println("doGroupingBy3");
    ...
    public static void doGroupingBy2(){
        System.out.println("doGroupingBy2");
        Stream<String> names = Stream.of("Martin", "Peter", "Joe", "Tom", "Tom", "Ann", "Alan");
    ...
    public static void doGroupingBy1(){
        System.out.println("doGroupingBy1");
        Stream<String> names = Stream.of("Martin", "Peter", "Joe", "Tom", "Tom", "Ann", "Alan");
        Map<Integer, List<String>> map =
                names.collect(
    ...
    public static void doCollectToMap3(){
        System.out.println("doCollectToMap3");
    ...
    public static void doCollectToMap2(){
        System.out.println("doCollectToMap2");
        ...
        Map<Integer, String> map = 
                Stream.of("cake", "biscuits", "tart", "bake")
                .collect(
                        ...
                        .collect(
                                Collectors.groupingBy(
                                        ...
                                        Collectors.mapping(
                                                s -> s,    // value is the String
                                                Collectors.toList()
                                        ) // Mapping function - collect values into a List
                                )
                        );
    ...
    public static void doCollectToMap1(){
        System.out.println("doCollectToMap1");
    ...
    public static void doAveragingInt(){
        System.out.println("doAveragingInt");
