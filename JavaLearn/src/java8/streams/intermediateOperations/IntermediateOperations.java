...
public class IntermediateOperations {
    ...
    public static void doSortedOther() {
        System.out.println("****doSortedOther****");
        // Stream<T> sorted()
    ...
    public static void doSorted2() {
        ...
        List<Person> persons = Stream.of(mary,john)
                .sorted(Comparator.comparing(p -> p.getAge()))
    ...
    public static void doSortedFromBook() {
        System.out.println("****doSortedFromBook****");
        // Stream<T> sorted()
        // Stream<T> sorted(Comparator<T> comparator)
        // Output:
    ...
    public static void doPeek() {
        System.out.println("****doPeek****");
        Stream.of("galway", "mayo", "roscommon")
                .peek(countyName -> System.out.print(" 1."+countyName))
                .filter(countyName -> countyName.length() > 5)
                .peek(countyName -> System.out.print(" 2."+countyName))
