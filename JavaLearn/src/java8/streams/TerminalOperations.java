...
public class TerminalOperations {
    ...
    public static void doCollect1(){
        ...
        // This version is used when you want complete control over how collecting should work. The accumulator adds an element to the collection e.g. the next String to the StringBuilder.
        // The combiner takes two collections and merges them. It is useful in parallel processing.
        ...
        System.out.println("doCollect1 " + word);// adjudicate
    }
    public static void doReduce3(){
        ...
        System.out.println("doReduce3 " + length);// 20
    }
    public static void doReduce2(){
        System.out.println("**************** doReduce2 Start ***************");
        // Optional<T> reduce(BinaryOperator<T> accumulator)
        // When you leave out the identity, an Optional is returned because there may not be any data (all the
        // elements could have been filtered out earlier). There are 3 possible results:
        ...
        Integer val = Stream.of(1,1,1, 3)
                //     .filter(n -> n > 5)      // val is 1 this way
                .reduce(2, (a, b) -> a );// val is 1 this way too
        System.out.println("doReduce2 val: " + val);// 1
        System.out.println("**************** doReduce2 End ***************");
    }
    public static void doReduce1(){
        System.out.println("**************** doReduce1 Start ***************");
        ...
        String name = Stream.of("s", "e", "a", "n")
             ...
             //   .reduce("", (s, c) -> s + c);
        System.out.println("doReduce1 name " + name);// sean

        Integer product = Stream.of(2,3,4)
                .reduce(1, (a, b) -> a * b);
        System.out.println("doReduce1 product " + product);// 24
        System.out.println("**************** doReduce1 End ***************");
    }
    public static void doForEach(){
        System.out.println("**************** doForEach Start ***************");
        // void forEach(Consumer)
        // As there is no return value, forEach() is not a reduction.
        // As the return type is 'void', if you want something to happen, it has to happen inside the Consumer (side-effect).
        ...
        System.out.println("**************** doForEach End ***************");
    }
    public static void doMatches(){
        System.out.println("**************** doMatches Start ***************");
        ...
        System.out.println("**************** doMatches End ***************");
    }
    public static void doFindAnyFindFirst(){
        System.out.println("**************** doFindAnyFindFirst Start ***************");
        // Optional<T> findAny()
        // Optional<T> findFirst()
        // These are terminal operations but not reductions as they sometimes return without processing all the elements in the stream. Reductions reduce the entire stream into one value.
        ...
        System.out.println("**************** doFindAnyFindFirst End ***************");
    }
    ...
    public static void doMinAndMax(){
        System.out.println("**************** doMinAndMax Start ***************");
        ...
        System.out.println("**************** doMinAndMax end ***************");

    }

    public static void doMinAndMax1(){
        System.out.println("************ doMinAndMax1 start ***************");
        // Optional<T> min(Comparator)
        // Optional<T> max(Comparator)
        // Optional introduce in Java 8 to replace 'null'. If the stream is
        // empty then the Optional will be empty (and we won't have to deal with null).
        ...
        System.out.println("**************** doMinAndMax1 end ***************");
