package concurrency.ocp11_from_oca8;
...
public class FixRaceWithSynchronized {
    ...
    public synchronized static void addToCounter1(){
//    public static void addToCounter(){ 
      // synchronized(FixRaceWithSynchronized.class){
//        synchronized(lock){   
            int c = count;
...
//        }
    ...
    public static void main(String[] args) {
       ...
       // callSynchronized();
        callStaticSynchronized();
    }

    static void callSynchronized(){
...
//            new Thread(() -> addToCounter())
    ...
    static void callStaticSynchronized(){
        for(int i=1; i<=10; i++){
            //new Thread(() -> FixRaceWithSynchronized.addToCounter1())
            new Thread(FixRaceWithSynchronized::addToCounter1)
                    .start();
        }
    }
